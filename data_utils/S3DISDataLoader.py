...
class S3DISDataset(Dataset):
    def __init__(self, split='train', data_root='trainval_fullarea', num_point=4096, test_area=5, block_size=1, sample_rate=1.0, transform=None):
        super().__init__()
...
if __name__ == '__main__':
    data_root = '/home/qc/uncert/PointNetand2/data/stanford_indoor3d/'
    num_point, test_area, block_size, sample_rate = 100000, 5, 20, 0.01
